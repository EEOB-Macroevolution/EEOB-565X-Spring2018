...
<table border=0 >
    ...
    <tr>
        ...
        <td>
            <a href="http://www.jstor.org/stable/1734207">Raup (1972)</a>
        </td>
        <td>
            DA/TH
        </td>
    ...
    <tr>
        ...
        <td>
            Lecture: Lineage diversification, mass extinctions, and extinction rates
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            Lecture: The tempo and mode of trait evolution
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            Lecture: Gradualism, stasis, and punctuated equilibrium; species sorting, species selection, evolutionary ‘channeling’ etc.
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            Lecture: Tree thinking and basic approaches to building phylogenies
        </td>
        <td>
            Yang (2014), Chapter 3
        </td>
    ...
    <tr>
        ...
        <td>
            Lecture: Trait comparisons, trait evolution on phylogenies: Comparative methods
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            Lecture: Statistical methods for reconstructing phylogenies
        </td>
        <td>
            Yang (2014), Chapter 4
        </td>
    ...
    <tr>
        ...
        <td>
            Software installation, final project planning
        </td>
        <td>
            none
        </td>
    ...
    <tr>
        ...
        <td>
            Theory: Bayesian methods for joint estimation of topology and divergence times using molecular and fossil data
        </td>
        <td>
            Heath and Moore (2014)
        </td>
        <td>
            TH
        </td>
    ...
    <tr>
        ...
        <td>
            Practical: Bayesian divergence time estimation in `RevBayes`
        </td>
        <td>
            [link]
        </td>
    ...
    <tr>
        ...
        <td>
            Theory: Variation in diversification rates, testing diversification rates
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            Practical: Estimating lineage diversification rates in `RevBayes`
        </td>
        <td>
            [link]
        </td>
    ...
    <tr>
        ...
        <td>
            Theory: Investigating trait correlations
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            Theory: Ancestral state reconstruction
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            Practical: Discrete trait analysis in `R` (molecules, discrete traits, continuous traits,  stochastic character mapping)
        </td>
        <td>
            [link]
        </td>
    ...
    <tr>
        ...
        <td>
            Theory: Statical methods for historical biogeography
        </td>
        <td>
            Landis et al (2014)
        </td>
    ...
    <tr>
        ...
        <td>
            Practical: Ancestral area reconstruction in `RevBayes`
        </td>
        <td>
            [link]
        </td>
    ...
    <tr>
        ...
        <td>
            Theory: Models of continuous trait evolution (BM, OU, early-burst, etc.)
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            Practical: Analysis of continuous trait evolution in `R`
        </td>
        <td>
            [link]
        </td>
    ...
    <tr>
        ...
        <td>
            Theory: Multivariate trait evolution
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            Practical: Analysis of multivariate traits in `R`
        </td>
        <td>
            [link]
        </td>
